...
I have also posted a <a href="assignments/pols1600_paper_template.qmd" download > template for the final paper</a> and an [example of a final paper](https://pols1600.paultesta.org/files/pols1600_final_paper_example){target="blank"} from a previous version of POLS 1600.
...
- Identify the source or sources of your data
  ...
  - If using multiple datasets, briefy describe how your final dataset was constructed.
