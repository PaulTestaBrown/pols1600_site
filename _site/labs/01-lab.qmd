...
2.  Create a new dataframe, called `covid_us`, by filtering out observations from the U.S. territories `- Use`\<-`,`%\>%`,`filter()`,`!`and`%in%\` ([slides](hhttps://pols1600.paultesta.org/slides/01-slides#108))
