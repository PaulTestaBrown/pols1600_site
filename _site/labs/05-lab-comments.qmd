...
# Intercept corresponds to the mean among Red States
coef(m2)[1]
mean(covid_us$new_deaths_pc_7day[covid_us$winner == "Trump"], na.rm=T)

# Slope corresponds to the difference in means between Red and Blue States
coef(m2)[1] + coef(m2)[2]
mean(covid_us$new_deaths_pc_7day[covid_us$winner == "Biden"], na.rm=T)
```
...
m3 <- lm(new_deaths_pc_14day ~ percent_vaccinated, covid_us,
...
# Deaths modeled by Republican vote share on 2021-09-23
m5 <- lm(new_deaths_pc_14day ~ rep_voteshare, covid_us,
         subset = date == "2021-09-23")
m5
