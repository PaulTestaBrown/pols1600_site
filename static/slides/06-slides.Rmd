...
$$\text{tc_diff} = \beta_0 + \beta_1\text{pol_interest} + \beta_2\text{age}$$
...
This interaction model essentially estimates separate models describing the relationship between `tc_diff` and `age`  for the interested and uninterested
...
class: inverse, middle, center
# 💡 
## Understanding what it means to "control for" X
