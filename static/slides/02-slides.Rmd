...
knitr::opts_chunk$set(
  ...
  message = FALSE, 
  comment = NA, dpi = 300,
  fig.align = "center", out.width = "80%",out.height = "80%", 
  cache = TRUE)
```
...
Today, we'll use the following libraries.
...
--
While that runs, let's do some review
...
- Less common, but can be harder to identify and fix
