...
- We can describe this distribution via:
  ...
  - simulation (e.g. permuting the outcome to break the relationship between outcome and predictors)
  - analytic theory (CLT)

- We quantify our uncertainty about our null hypothesis using a p-value  the probability of observing a test statistic as extreme or more extreme in a world where our null hypothesis was true

  - If our p-value is small (p < 0.05), we reject the null hypothesis because we would observe what we did only small percent of the time

  - If our p-value is large (p > 0.05), we fail to reject the null, or retain the null hypothesis as plausible.
