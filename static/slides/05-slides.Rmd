...
```{r red_covid, echo=F, fig.height=5}
knitr::include_graphics("https://static01.nyt.com/newsgraphics/2022/02/03/ambriefing-red-covid/5e2413bbdc223f7d0ba6deb062129be4f741b5e1/trumpshare-us-deaths-600.png")
```

[Red Covid, an Update](https://www.nytimes.com/2022/02/18/briefing/red-covid-partisan-deaths-vaccines.html) *New York Times*
...
df_wk04 <- haven::read_spss("../files/data/wk04.sav")
df_wk04 %>%
  filter(Q7 == 1)-> df_wk04
```
...
The following slides walk you through the mechanics of this exercise. We're gonna skip them in class, but they're there for your reference
