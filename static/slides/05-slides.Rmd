...
```
  ...
  - Will estimate the intercept $(\beta_0)$ and the slope $(\beta_1)$ in the following equation.
...
- Theoretical
  - Linear regression provides a **linear** estimate of the conditional expectation function $E[Y|X]$
