...
`Group 3` = c("Will Lake", "Catherine Morrissette", "Amanda Page", "Noah Soutier", ""),
...
`Group 7` = c("Natalia Ibarra", "Khaled Abdo", "Starrchild Jackson", "Selene Luna", "Taha Siddiqui")
)
...
- **Selection Bias:** $E[Y(0)|D=1] - \mathbf{E[Y(0)|D=0]}$, 
    ...
    - This what **confounds our causal claims** if we just compare outcomes among people who went to the hopsital and people who didn't
