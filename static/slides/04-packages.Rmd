...
-  Sometimes R will ask you where and how you want to install/update these dependencies. Type the number 1 into your console and hit enter (this should try to install everything, but I can't seem to recreate this on my machine)
...
Again, this is a pain and sort of cryptic, but you only have to do it once.
