...
4. Create an R Markdown File (.Rmd) in R Studio
  - File > New File > R Markdown
  - Install the requested packages (`rmarkdown`)
5. Knit this R Markdown File into an html file. 
...
To work, so make sure you open your first .Rmd file first (this will automatically prompt your to install `rmarkdown`)
...
- Next, create a R Markdown document (.Rmd) by clicking **Click File > New File > R Markdown**
...
- R Studio will likely give you a pop up telling you you need to install additional packages, `rmarkdown` and some packages `rmarkdown` needs. Please do so

## Install the `rmarkdown` package

- Once `rmarkdown` is intalled, R Studio should ask you what kind of file you want to make, choose html (the default) and fill in things like the title or author if you want.
