...
3. **Open R Studio on your machine.** There are four "panes" which correspond rougly to:
    - The top left is where you'll right your code (Source/Text Editor). Will appear once you open a file.
    - The bottom left is where you'll run your code (Console)
    - The top right is a list of what you've done (Workspace/Environmnt)
    - The bottom right is a collection of things we'll go over in class, things like packages plots (Potpourri)
4. **RStudio will likely ask you to install a bunch of packages on start up. Please do so. Get a coffee or check your email**
...
6. **Click the knit button** in the Source/Text editor on the upper left and see what happens
    ...
    - Quite possibly, you'll get some error. That's fine and to be expected when starting up. The goal of having you do this on your own is to try and get to and resolve those barriers as quickly as possible. So don't sweat it too much. We'll take care of things in class on Thursday
