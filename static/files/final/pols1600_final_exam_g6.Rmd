...
author: "Group 6: Logan Torres, Jonathan Zhang, Osiris Russell-Delano, Aicha Sama"
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/g6/df_g6.rda"))
...
**Your task in this section is to explore variation in support for regulations on greenhouse emissions** using the data available to you. 

What specific factors you focus on are up to you. Your dataset also contains the following variables:

- **`V201432x`** - During the past few months, would you say that most of the actions taken by protestors to get the things they want have been violent, or have most of these actions by protesters been peaceful, or have these actions been equally violent and peaceful?
  - Note this is reference to protests following George Floyd's death. It was the closest the NES came to asking about activists.
...
These may or may not be relevant to your specific question, but they should give you some different things to think about.

You might focus on partisan or generational differences in support or other variation across social and economic strata using other predictors in the NES. 

You might also bring in additional information about where respondents live (say by constructing an indicator of whether their state boarders an ocean, or even merging in outside data on average temperatures or rainfall in 2020 in these states) This option is by no means required. It would be more work, and would create opportunities for potential errors in your code, but could also be more interesting. Again, it's up to you.  
...
What do you think explains variation in support regulation around climate change?
