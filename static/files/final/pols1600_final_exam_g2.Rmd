...
author: "Group 2: Elizabeth Steeves,Fabian Lopez,Lorenzo Mahoney, Ariana Palomo"
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/g2/df_g2.rda"))
...
**Your task in this section is to explore variation in Latine support for Donald Trump in the 2020 election** using the data available to you. 

Your primary outcome of interest is thus:

- **`V202073`** POST: FOR WHOM DID R VOTE FOR PRESIDENT

Your key predictor will likely be constructed from

- **`V201549x`** PRE: SUMMARY: R self-identified race/ethnicity

You may also wish to bring in information from:

- **`V201558x`** PRE: SUMMARY: HISPANIC SUMMARY

How you approach this question is up to you. You may compare Latine respondents to other respondents with the NES **OR** You might subset the data and focus only on variation within respondents who identify as Latine. Either approach is reasonable, just be sure to explain 
...
Are you interested in whether Latine respondents in the NES voted at higher rates for Donald Trump than other racial and ethnic groups and why this might be? Or are you interested in understanding among Latine respondents, what predicts variation in support for Trump? 
