...
author: "Group 3:Will Lake,Taha Siddiqui , Amanda Page, Noah Soutier"
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/g3/df_g3.rda"))
...
**Your task in this section is to explore variation in perceptions of the impact of climate change on severe weather** using the data available to you. 

What specific factors you focus on are up to you. You might focus on partisan or generational differences in perception or other variation across social and economic strata using other predictors in the NES. 
...
What do you think explains variation in perceptions about the impact of climate change?
