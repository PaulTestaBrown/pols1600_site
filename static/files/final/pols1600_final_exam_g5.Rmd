...
author: "Group 5: Theo Simmons,Fengyu Seah, Hunter Keneley, Schuyler Dubitsky"
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/g5/df_g5.rda"))
...
**Your task in this section is to examine age gaps in voting** using the data available to you. 

Your primary outcome should be constructed from:

- **`V202068x`** POST: SUMMARY: POST VOTE STATUS FOR REGISTERED RESPONDENTS

Your key predictor should be constructed from:

- **`V201507x`** PRE: SUMMARY: Respondent age


Your first task should be to establish whether or not age gaps exist. Then you should explore some potential reasons for why these gaps exist, perhaps examining differences in income and education across generations or other factors. 

In addition to the variables above, your dataset also contains the following which may be relevant for your inquiries^[They may not, no need to include any of these predictors, but I wanted to give you some possible directions to explore. I probably would focus on a few emotions like anger, hope and fear, rather than all of the affective measures]:
...
You might also bring in additional information about where respondents live (say by constructing an indicator of whether they live in a red or blue state) This option is by no means required. It would be more work, and would create opportunities for potential errors in your code, but could also be more interesting. Again, it's up to you.  
...
What do you think explains generational differences in voting? Is it a matter of time and resources? Is it a function of differential views about government? Or are some groups more likely to mobilized than others? You need not explore all or any of these questions. Find something that interests you as a group.

> Write your answer here


Again don't worry about coming up with the perfect explanation (you have limited data). But try to develop a question and set of expectations that you think would be substantively interesting to explore.
