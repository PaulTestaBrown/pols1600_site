...
author: "Group 1: Anna Lister, Kate Kuli, Andreas Young, Claudia Spelman"
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/g1/df_g1.rda"))
...
You primary outcome of interest in the data comes from the following variable: 
...
Don't worry about coming up with the perfect explanation (you have limited data). But try to develop a question and set of expectations that you think would be substantively interesting to explore.
...
Now recode the data to use in your analysis. At a minimum you will need to create new variables from the raw variables listed above for:
  ...
  - Additional covariates that:
    ...
    - might moderate the effect of your key predictor on the outcome (Heterogeneous/conditional effects)
