...
You will **submit the html file** produced by this .Rmd file on **[on Canvas by May 12, 11:59 pm.](https://canvas.brown.edu/courses/1087979/assignments/7881310)**
...
- Present a linear regression model as a formatted html regression table `answer`
...
# Load data
load(url("https://pols1600.paultesta.org/files/data/df_g1.rda"))
...
Additionally, your data contain: 

- `val1_turnout20` a validated measure of turnout in the 2020 election, with the following values:
  - 1  Linkage not attempted due to no PII
  - 2  Linkage attempted, no record found 
  - 3  Linked, not voting 
  - 4  Linked, voted absentee/by mail 
  - 5  Linked, voted early 
  - 6  Linked, voted in person on election day 

**Your task in this section is to explore variation in voting early and/or absentee/mail voting in the 2020 election** using the data available to you. 

What specific factors you focus on are up to you. 

You may look at only early voting, or voting by mail, or both. 

You may explore variation across social and economic strata using other predictors in the NES. 

You might instead bring in additional information about the policies adopted by states in the run up to the 2020 election (e.g. create an indicator of whether respondents lived in states that expanded early voting options). This option is by no means required. It would be more work, and would create opportunities for potential errors in your code, but could also be more interesting. Again, it's up to you.  
...
## Formalize your question and expectations,

What do you think explains variation in early voting/voting by mail in the 2020 election? Do you think certain groups were more or less likely to use these options? Do you think rates of voting were higher blue states vs red states?  What are some alternative explanations for your expected pattern of results?
...
Now recode the data to use in your analysis. At a minimum you will need to create new variables from the raw variables listed above for:
  ...
  - Your key outcome of interest (aka your dependent variable, it should probably be a binary indicator)
...
A few more suggestions:
  ...
  - Think about your population of interest, do you want to look at all respondents, only registered voters, only voters? 
...
Please calculate the following descriptive statistics for your the variables you will use in your analyses
...
Please estimate the at least two models:
