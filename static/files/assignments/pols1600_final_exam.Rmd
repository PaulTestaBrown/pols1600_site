...
- **Code Advice** Again the [final paper template](https://pols1600.paultesta.org/files/assignments/pols1600_paper_template) has lots of code that should be useful for you.
