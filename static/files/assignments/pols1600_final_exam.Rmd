...
If you submit the Rmd instead of the `html` you will lose 5 points from your exam grade.
...
-   Explain the key identifying asssumptions of the design
...
-   Why would would we want to control for covariates?

-   How linear regression accomplish this
...
-   If the skeptic is completely wrong, and geography has no relationship to vaccination rates, what should we expect in terms of the size and significance of the coefficient on rural status? How will the coefficient on partisnaship in this model change?
...
- **Code Advice** Look at the [final paper template](https://pols1600.paultesta.org/files/assignments/pols1600_paper_template)
...
```{r}
knitr::include_graphics("https://pols1600.paultesta.org/files/assignments/final_fig.png")
```
