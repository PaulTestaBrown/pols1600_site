...
- Announcements (20)
  - [Assignment 1: Research Questions](https://pols1600.paultesta.org/assignments/a1) due Tuesday, March 12
...
- Prompt posted on website [here](https://pols1600.paultesta.org/assignments/a1)

- 3 possible research questions uploaded to Canvas by [Next Tuesday, March 12]{.blue}
...
- Uploaded to Canvas by [Friday, March 22]{.blue}
...
- So let's try to get those numbers up and will summarize the results of the [survey](https://brown.co1.qualtrics.com/jfe/form/SV_bDFDWRGcnpm09hk){target="_blank"} next week
