...
## What you don't really need to know for POLS 1600

We won't spend much time on the formal definitions or math behind
...
## Seven Layers of Graphics{background-image=https://miro.medium.com/max/1400/1*ZdQ9wFwaA214ABiib7AygQ.png
...
df %>%
  ...
  scale_fill_brewer() +
  coord_flip() +
  labs(title = "Who controls the playlist on a roadtrip") -> fig_roadtrip
```
...
- Visualizing distributions helps us understand both typical values and variation.

- Today let's see how to visualize some distributions in the Covid data using:
