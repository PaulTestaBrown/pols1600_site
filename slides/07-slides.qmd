...
- Generalizes to multiple periods and treatment interventions, with [fixed effects]{.blue}
...
:::
  ...
  - [Unit fixed effects]{.blue} control for time-invariant differences across units
  - [Period fixed effects]{.blue} control for unit-invariant differences across periods
...
- Interpretation of the [two-way fixed effects]{.blue} is [complicated]{.blue}...
...
- In this week's lab we'll be conducting a partial replication of @Grumbach2022-zj “Rock the Registration: Same Day Registration Increases Turnout of Young Voters.”
...
![](images/07_rep6.png)
## Q2: Load the data into R

If you've saved the dataverse_files into.
