...
- [What's a typical value in our data]{.blue}
  ...
  - [Mean](https://pols2580.paultesta.org/labs/01-lab-comments.html#mean)
  - [Median](https://pols2580.paultesta.org/labs/01-lab-comments.html#median)
  - [Mode](https://pols2580.paultesta.org/labs/01-lab-comments.html#modes)

- [How much do our data vary?]{.blue}

  - [Variance](https://pols2580.paultesta.org/labs/01-lab-comments.html#variance)
  - [Standard deviation](https://pols2580.paultesta.org/labs/01-lab-comments.html#standard-deviations)

- As one variable changes [how does another change]{.blue}?

  - [Covariance](https://pols2580.paultesta.org/labs/01-lab-comments.html#covariance)
  - [Correlation](https://pols2580.paultesta.org/labs/01-lab-comments.html#correlation)
...
## Levels of understanding in POLS 2580
...
Here's a [detailed guide](https://pols2580.paultesta.org/resources/04-packages) of what we'll do in class right now.
...
Please follow these steps so you can download data directly from the U.S. Census [here](https://pols2580.paultesta.org/resources/04-packages.html#3_Install_a_Census_API_tidycensus_package):
...
[Please download]{.blue} the lab [here](https://pols2580.paultesta.org/labs/05-lab.qmd)
...
```{r}
#| label: lmdata
load(url("https://pols2580.paultesta.org/files/data/03_lab.rda"))
