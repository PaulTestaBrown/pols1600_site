...
— Bottlegate (@Bottlegate) <a href="https://twitter.com/Bottlegate/status/855250365402447872?ref_src=twsrc%5Etfw">April 21, 2017</a>
...
::: {.column width="48%"}
[What are we ]{.fragment}[worried]{.blue} about?
...
Here are the global options for these slides:[^2]

[^2]: I'll generally do this for you, but it's useful to know that you can change options globally (for every chunk) and locallys (for specific chunks)
