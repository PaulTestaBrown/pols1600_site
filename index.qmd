...
::: g-col-4
[{{< fa check-to-slot size=3x >}}](https://canvas.brown.edu/courses/1094972/assignments)
...
::: g-col-4
[{{< fa map-location-dot size=3x >}}](https://brown.edu/Facilities/Facilities_Management/maps/index.php#building/BH)
...
::: g-col-4
[{{< fa video size=3x >}}](https://brown.zoom.us/j/94330157279)

### Zoom
:::

::: g-col-4
[{{< fa person-circle-question size=3x >}}](https://calendar.google.com/calendar/u/0/selfsched?sstoken=UUg1TkI2bmtYWi1kfGRlZmF1bHR8OTkyODI5NjQzN2E3YzUwZjQwM2EyNGUyYzYyNGE4OWY)
...
slides[c(10,seq(22,28, by=2))] <- as.character(fa("comments"))
labs[c(10,seq(22,28, by=2))] <- as.character(fa("laptop-file"))
comments[c(10, seq(22,28, by=2))] <- as.character(fa("graduation-cap"))
assignments <- rep(" ", 28)
