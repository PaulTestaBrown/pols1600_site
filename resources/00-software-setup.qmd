...
4.  Create an Quarto Markdown Document (.qmd) in R Studio
...
-   **Download R here:** <https://cran.r-project.org/>
    -   Make sure your operating systems are up to date.
        -   Mac: at least macOS 12 (Monterey) (Latest: macOS Sonoma 14.3 ). Note different versions for Intel vs Apple M1/M2/M3 chips
