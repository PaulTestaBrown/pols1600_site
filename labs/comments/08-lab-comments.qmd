...
In most of these simulations, Obama will lose Alabama and win California. However, in each simulation, these probabilities suggest there's a chance he wins Alabama (3 percent) or loses California (2 percent)[^1]

[^1]: Here we're assuming these probabilities are independent. Actual forecasting models like 538 or the NYT generally assume the probabilities of winning some states correlate with the probability of winning other neighboring states.
